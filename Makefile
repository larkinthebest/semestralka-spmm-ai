...
install: setup migrate-db
	@echo "Setup complete. Remember to download AI models if needed."
...
help:
	@echo "AI Multimedia Tutor - Makefile Commands"
	@echo "-------------------------------------"
	@echo "  make install        - Set up virtual environment and install Python dependencies."
